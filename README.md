go-chart
========
[![CircleCI](https://circleci.com/gh/tensz/go-chart.svg?style=svg)](https://circleci.com/gh/tensz/go-chart) [![Go Report Card](https://goreportcard.com/badge/github.com/tensz/go-chart)](https://goreportcard.com/report/github.com/tensz/go-chart)
...
```bash
> go get -u github.com/tensz/go-chart
```
...
![](https://raw.githubusercontent.com/tensz/go-chart/master/_images/tvix_ltm.png)

Single axis:

![](https://raw.githubusercontent.com/tensz/go-chart/master/_images/goog_ltm.png)

Two axis:

![](https://raw.githubusercontent.com/tensz/go-chart/master/_images/two_axis.png)

# Other Chart Types

Pie Chart:

![](https://raw.githubusercontent.com/tensz/go-chart/master/_images/pie_chart.png)

The code for this chart can be found in `examples/pie_chart/main.go`.

Stacked Bar:

![](https://raw.githubusercontent.com/tensz/go-chart/master/_images/stacked_bar.png)
...
import (
    ...
    "bytes"
    ...
    "github.com/tensz/go-chart" //exposes "chart"
)
